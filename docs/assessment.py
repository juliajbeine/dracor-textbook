...
def create_answer_box(question_id: str, rows: int = 4, placeholder: str = "Ihre Antwort") -> HTML:
    ...
    <div style="padding: 5px; border-radius: 5px; margin: 10px 0;">
        <textarea id="answer-{question_id}" rows="{rows}" style="width: 100%; margin-top: 10px; padding: 10px; border: 1px solid #ced4da; border-radius: 4px;" placeholder="{placeholder}"></textarea>
